...
import 'package:healora/features/select_appointment/presentation/widgets/doctor_info.dart';
import 'package:healora/features/select_appointment/presentation/widgets/select_date.dart';
import 'package:healora/features/select_appointment/presentation/widgets/select_time.dart';

class SelectAppointmentScreen extends StatelessWidget {
  static final List<SelectDate> dates = [
    SelectDate(),
    SelectDate(),
    SelectDate(),
    SelectDate(),
  ...
  static final List<SelectTime> time = [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Book Appointment"), centerTitle: true),
      body: Padding(
